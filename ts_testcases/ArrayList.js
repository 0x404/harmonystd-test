"use strict";
function test_array_push(loopCount) {
...
function test_array_splice_insert(loopCount) {
...
function test_array_includes_worst(loopCount) {
...
function test_array_includes_best(loopCount) {
    // test: Array.prototype.includes
